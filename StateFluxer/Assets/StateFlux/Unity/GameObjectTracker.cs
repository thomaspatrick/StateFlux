...
namespace StateFlux.Unity
{
    ...
    public class GameObjectTracker : IGameObjectTrackingListener
    {
        ...
        public GameObject StateCreateGameObject(Change2d change, bool asHost)
        {
            ...
            StateFluxTracked stateFluxTracked = obj.AddComponent<StateFluxTracked>();
            stateFluxTracked?.SetListener(this);
